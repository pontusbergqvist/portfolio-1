...
const Overlay = ({ active, setActive, current }) => {
  return (
    <>
      <div className={`fixed ${!active ? 'right-[-100vw]' : 'right-[0vw]'} h-screen text-headingTertiary text-right pr-5 pb-5 bg-slate-100 dark:bg-primary dark:text-darkText w-screen z-20 flex flex-col justify-end items-center`}>
