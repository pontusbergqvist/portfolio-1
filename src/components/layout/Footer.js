...
const Footer = () => {
  return (
    <footer className='max-w-[1400px] h-[420px] px-3 mx-auto flex flex-col justify-center font-dankMono text-primary  dark:text-darkText before:content-[""] before:h-[2px] before:w-[80%] before:max-w-[350px] before:block before:bg-primary before:mb-5 before:dark:bg-darkText'>
