  ...
  return (
    <div className="text-primary w-full h-[calc(100vh_-_70px)] relative">
      <div className='max-w-[1400px] h-full mx-auto flex justify-between items-center px-3'>
        <div className='w-1/2 leading-[1.3]'>
          <p className='relative inline-block  after:content-[""] after:block after:w-[50px] after:bg-primary after:h-[1px] after:absolute after:top-1/2 after:right-0 after:translate-x-[70px]'>Featured Project</p>
          <h2 className='font-dankMono text-heading'>Project name</h2>
          <Tags tags={['Gatsby', 'React', 'JavaScript']} />
          <Link to="">Project details</Link>
        </div>
        <img className='max-w-full h-auto' src="https://www.laralee.design/wp-content/uploads/2020/03/blog-20200309-web-design-display-1-nick-tarasov-get-over-the-fear-of-waste.jpg" alt="" />
      </div>
